var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_-8356e293.js"
	},
	{
		type: "script",
		href: "/assets/entry-client-afaa51e1.js"
	},
	{
		type: "style",
...
}, "/_m/33fbce88a9/routeData", true);
server$.registerHandler("/_m/33fbce88a9/routeData", $$server_module0$1);
function routeData() {
...
function getAssetsFromManifest(manifest, routerContext) {
  ...
  const links = match.reduce((r, src) => {
    r[src.href] = src.type === "style" ? ssr(_tmpl$$3, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : src.type === "script" ? ssr(_tmpl$2, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : undefined;
    return r;
  }, {});
...
const _tmpl$$1 = ["<main", "><!--#-->", "<!--/--><h1>Hello world!</h1><!--#-->", "<!--/--><p>", "</p></main>"];
const $$server_module0 = server$.createHandler(async function $$serverHandler0() {
  return "Hello world <from server>!";
}, "/_m/33fbce88a9/routeData", true);
server$.registerHandler("/_m/33fbce88a9/routeData", $$server_module0);
function Home() {
  const data = useRouteData();
  return ssr(_tmpl$$1, ssrHydrationKey(), escape(createComponent(Title, {
    children: "Hello World"
  })), escape(createComponent(Counter, {})), escape(data()));
}
